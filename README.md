...
Click the branch name in the navbar to open a full git interface to browse commit history, switch branches, fetch, pull, push, and visualize your git all without leaving Quarterdeck. Keep track of everything your agents are doing across branches as work is completed.
