...
## Improve file browser text selection and copy

Selecting and copying code in the file browser does not work reliably. Improve text selection behavior, clipboard copying, and keyboard shortcuts; if possible, `Cmd+A` should select the current file content instead of the whole page or surrounding app chrome.
