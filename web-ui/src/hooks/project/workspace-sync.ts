/**
 * Pure domain logic for workspace state synchronization.
 *
 * No React imports — functions here take explicit parameters and return
 * plain data. The companion hook (`use-workspace-sync.ts`) handles React
...
/**
 * Determine whether an incoming workspace state update should be applied,
 ...
 */
export function shouldApplyWorkspaceUpdate(
 ...
 * workspace state (full hydration), or whether only sessions should be
