...
interface TopBarOpenProjectControlProps {
...
function OpenTargetIcon({ option }: { option: OpenTargetOption }): React.ReactElement {
	return (
		<img
			...
			alt=""
			aria-hidden
			className="block size-3.5 object-contain opacity-90 [filter:brightness(0)_invert(1)]"
		/>
	);
}

export function TopBarOpenProjectControl({
	options,
	selectedOptionId,
	disabled,
	loading,
	onOpen,
	onSelectOption,
}: TopBarOpenProjectControlProps): React.ReactElement | null {
