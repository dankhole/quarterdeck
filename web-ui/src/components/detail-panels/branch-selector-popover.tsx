...
import { Fzf } from "fzf";
import { Check, ChevronDown, ClipboardCopy, GitBranch, GitCompareArrows, LogIn, Search } from "lucide-react";
		...
		<ContextMenu.Root>
			...
			<ContextMenu.Portal>
				<ContextMenu.Content className="z-50 min-w-[160px] rounded-md border border-border-bright bg-surface-1 p-1 shadow-lg">
					...
					{onCheckout || onCompare ? <ContextMenu.Separator className="my-1 h-px bg-border" /> : null}
					<ContextMenu.Item
