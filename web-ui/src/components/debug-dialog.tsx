	...
	return (
		<>
			<Dialog open={open} onOpenChange={onOpenChange}>
				...
				<DialogBody className="space-y-4">
					...
					<div className="rounded-md border border-border bg-surface-2 p-3">
						...
						<p className="mt-1 text-xs text-text-secondary">
							Clears browser local storage and removes <code>~/.quarterdeck</code> and{" "}
							<code>~/.quarterdeck/worktrees</code>. Quarterdeck reloads after completion.
						</p>
						<Button
							variant="danger"
							size="sm"
			...
			<AlertDialog open={isResetConfirmOpen} onOpenChange={setIsResetConfirmOpen}>
				...
				<AlertDialogBody>
					<AlertDialogDescription>
						This removes local browser storage and deletes <code>~/.quarterdeck</code> and{" "}
						<code>~/.quarterdeck/worktrees</code>.
					</AlertDialogDescription>
