	...
	return (
		<>
			<Dialog open={open} onOpenChange={onOpenChange}>
				...
				<DialogBody className="space-y-4">
					...
					<div className="rounded-md border border-border bg-surface-2 p-3">
						...
						<p className="mt-1 text-xs text-text-secondary">
							Clears browser local storage and removes <code>~/.cline/kanban</code> and{" "}
							<code>~/.cline/worktrees</code>. Kanban reloads after completion.
						</p>
						<Button
							variant="danger"
							size="sm"
			...
			<AlertDialog open={isResetConfirmOpen} onOpenChange={setIsResetConfirmOpen}>
				...
				<AlertDialogBody>
					<AlertDialogDescription>
						This removes local browser storage and deletes <code>~/.cline/kanban</code> and{" "}
						<code>~/.cline/worktrees</code>.
					</AlertDialogDescription>
