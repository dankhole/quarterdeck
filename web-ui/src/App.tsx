...
export default function App(): ReactElement {
	...
	const gitContextValue = useMemo<GitContextValue>(
		() => ({
			// useGitActions
			runningGitAction,
			gitActionError,
																	...
																	branchStatusSlot={
																		homeGitSummary ? (
																			<GitBranchStatusControl
																				branchLabel={
																					homeGitSummary.currentBranch ?? "detached HEAD"
																				}
																		...
																		<ScopeBar
																			...
																			branchPillSlot={
																				<BranchSelectorPopover
																					...
																					onMergeBranch={
																						fileBrowserBranchActions.handleMergeBranch
																					}
																					onCreateBranch={
																						fileBrowserBranchActions.handleCreateBranchFrom
																					}
																					onDeleteBranch={
																						fileBrowserBranchActions.handleDeleteBranch
																					}
																					onPull={
